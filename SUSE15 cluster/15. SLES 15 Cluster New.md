...
## nvidia
到nvidia官網下載以下安裝包
NVIDIA HPC SDK >>>[NVIDIA HPC SDK](https://developer.nvidia.com/nvidia-hpc-sdk-releases) 
CUDA Toolkit>>>[CUDA Toolkit](https://developer.nvidia.com/cuda-toolkit-archive) 
```bash
linux :~ # ls -l
...
---
## vasp
本部分的編譯皆有加入 vtstcode及 solvent進行編譯
到vtst官網下載vtstcode(用於編譯NEB等功能)>>>[vtstcode下載連結](http://theory.cm.utexas.edu/vtsttools/download.html) 
