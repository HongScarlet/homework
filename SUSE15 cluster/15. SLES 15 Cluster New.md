...
zypper in gcc-fortran         # 後續編譯vasp需要
zypper in libncurses5         # 後續編譯vasp需要
...
CC         = icc
修改為
CC         = icc -I/opt/nvidia/hpc_sdk/Linux_x86_64/21.3/cuda/11.2/targets/x86_64-linux/include -I/opt/nvidia/hpc_sdk/Linux_x86_64/21.3/math_libs/11.2/targets/x86_64-linux/include

將
CUDA_LIB   := -L$(CUDA_ROOT)/lib64 -lnvToolsExt -lcudart -lcuda -lcufft -lcublas
修改為
CUDA_LIB   := -L/opt/nvidia/hpc_sdk/Linux_x86_64/21.3/cuda/11.2/targets/x86_64-linux/lib -lnvToolsExt -lcudart -lcuda -L/opt/nvidia/hpc_sdk/Linux_x86_64/21.3/math_libs/11.2/targets/x86_64-linux/lib -lcufft -lcublas
● 修改cuda lib
...
將以下的gencode=arch=compute_30這行給刪除
