...
<pre><code>jsonHandler、createHandler、editHandler與上一次之功能相同
分別為查詢、創建、編輯使用者資料(詳細見[20200115_test.md](https://github.com/HongScarlet/homework/blob/master/GO/20200115_test.md "link"))
