...
<pre><code>jsonHandler、createHandler、editHandler與上一次之功能相同，分別為查詢、創建、編輯使用者資料(詳細見[20200115_test.md](https://github.com/HongScarlet/homework/blob/master/GO/20200115_test.md "link"))
可以利用"/upload"來更新csv內的資料(ex:創建使用者之後)，並且後台會將更新後的資料顯示出來
</code></pre>
...
結論
<pre><code>可以看到在createfile前後，後台upload使用者的資料數量多了一筆
</code></pre>
***
